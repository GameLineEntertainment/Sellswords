...
public class MyMouseOrbit : MonoBehaviour 
{
	...
	void LateUpdate () 
	{
        ...
        if(CameraSpeedX != 0 || CameraSpeedY != 0 || CameraSpeedZ != 0)
        CameraRotate();
...
void OnGUI()
	{
        ...
        GUILayout.Label("Auto Rotate Right");
        CameraSpeedX = GUILayout.HorizontalSlider(CameraSpeedX, -1, 1F);
      //  GUILayout.BeginHorizontal();
        GUILayout.Label("Auto Distance");
        CameraSpeedZ = GUILayout.VerticalSlider(CameraSpeedZ, -1, 1F);
        //GUILayout.EndHorizontal();
        GUILayout.Label("Auto Rotate Up");
        CameraSpeedY = GUILayout.VerticalSlider(CameraSpeedY, -1, 1F);          
    }
    ...
    void CameraRotate()
    {
        ...
        distance -= CameraSpeedZ * Time.deltaTime;
    }
}
